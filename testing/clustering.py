...
def pca_hierarchical(team_id, year = 2017, n_clusters = 160, pca_flag=False, linkage="ward"):
...
def pca_hierarchical_ward(team_id, year = 2017, n_clusters = 160):
    return hierarchical(team_id, year, n_clusters, pca_flag=True, linkage="ward")

def pca_hierarchical_complete(team_id, year = 2017, n_clusters = 160):
    return hierarchical(team_id, year, n_clusters, pca_flag=True, linkage="complete")

def pca_hierarchical_average(team_id, year = 2017, n_clusters = 91):
    return hierarchical(team_id, year, n_clusters, pca_flag=True, linkage="average")

def pca_hierarchical_single(team_id, year = 2017, n_clusters = 91):
    return hierarchical(team_id, year, n_clusters, pca_flag=True, linkage="single")
